...
COCO_MODEL_PATH =  r"C:\Users\usov_\source\repos\ParkingAPI\FreeParkingModel\resources\mask_rcnn_coco.h5"
...
while video_capture.isOpened():
    ...
    if parked_car_boxes is None:
        ...
        if free_space_frames > 10:
            ...
            conn = sqlite3.connect(r'C:\Users\usov_\source\repos\ParkingAPI\ParkingAPI\db.sqlite3')
            cursor = conn.cursor()
            result = None
            query = """
                        UPDATE
                        ...
                        SET
                               is_free = TRUE
                        WHERE
                               address = "Россия Москва Марьино, улица Поречная"
                     """
           # try:
